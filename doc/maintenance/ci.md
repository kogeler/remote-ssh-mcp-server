...
Hardware-token tests remain operator controlled.
...
the publication job downloads rather than rebuilds them.
...
that section is preserved. The workflow re-reads the body immediately before
